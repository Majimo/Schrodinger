...
const CACHE_NAME = "Schrodinger-cache";
const OFFLINE_URL = "Schrodinger.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Schrodinger.html","Schrodinger.js","Schrodinger.wasm","Schrodinger.pck","Schrodinger.offline.html","Schrodinger.icon.png","Schrodinger.apple-touch-icon.png"];
